    ...
    with col2:
        ...
        if listfilter == "Canny":
            ...
            ctx = webrtc_streamer(key="example1", video_processor_factory=VideoProcessor,
                                  media_stream_constraints={"video": True, "audio": False})
            if ctx.video_processor:
                ctx.video_processor.threshold1 = st.slider("Configure Threshold2", min_value=-255, max_value=255,
                                                           step=1,
                                                           value=100)
                ctx.video_processor.threshold2 = st.slider("Configure Threshold2", min_value=-255, max_value=255,
                                                           step=1,
                                                           value=150)
            ...
            ctx = webrtc_streamer(key="example1", video_processor_factory=VideoProcessor,
                                  media_stream_constraints={"video": True, "audio": False})
            if ctx.video_processor:
                ctx.video_processor.lower_hsv1 = st.slider("Konfigurasi HSV2", min_value=-255, max_value=255, step=1,
                                                           value=100)
                ctx.video_processor.upper_hsv2 = st.slider("Konfigurasi HSV2", min_value=-255, max_value=255, step=1,
                                                           value=150)
    ...
    with col3:
        ...
        if listfilter == "Canny":
            ...
            ctx = webrtc_streamer(key="example2", video_processor_factory=VideoProcessor,
                                  media_stream_constraints={"video": True, "audio": False})
            if ctx.video_processor:
                ctx.video_processor.threshold1 = st.slider("Configure Threshold3", min_value=-255, max_value=255,
                                                           step=1,
                                                           value=100)
                ctx.video_processor.threshold2 = st.slider("Configure Threshold3", min_value=-255, max_value=255,
                                                           step=1,
                                                           value=150)
            ...
            ctx = webrtc_streamer(key="example2", video_processor_factory=VideoProcessor,
                                  media_stream_constraints={"video": True, "audio": False})
            if ctx.video_processor:
                ctx.video_processor.lower_hsv1 = st.slider("Konfigurasi HSV3", min_value=-255, max_value=255, step=1,
                                                           value=100)
                ctx.video_processor.upper_hsv2 = st.slider("Konfigurasi HSV3", min_value=-255, max_value=255, step=1,
                                                           value=150)
