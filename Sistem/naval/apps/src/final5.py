...
if __name__ == "__main__":
    # Ensure set_start_method is called only once and before any multiprocessing code
    multiprocessing.set_start_method('spawn', force=True)

    reader_process = multiprocessing.Process(target=frame_reader, args=(frame_queue,))
    processor_process = multiprocessing.Process(target=process_frames, args=(frame_queue,))
